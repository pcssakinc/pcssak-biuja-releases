...
`THIRD-PARTY-NOTICES.txt`, 공개 저장소의 [제3자 소프트웨어 라이선스 고지](THIRD-PARTY-NOTICES.txt),
[MPL 구성요소 원본 소스 안내](docs/THIRD-PARTY-SOURCE.md)와 해당 고지문을 따릅니다.
...
프로그램 제거 시 설정·작업저널·로그 등 로컬 앱 데이터는 파일시스템 안전을 위해 보존됩니다.
앱을 완전히 종료하고 제거한 뒤 [개인정보 처리방침](PRIVACY.md)의 수동 삭제 안내를 확인하세요.
Windows 휴지통과 사용자가 정리한 실제 파일은 앱 데이터 폴더와 별개입니다.
...
약관과 제품에 관한 일반 문의: `support@pcssak.com`
...
`THIRD-PARTY-NOTICES.txt`, the public repository's
[third-party software notices](THIRD-PARTY-NOTICES.txt), the
[MPL component source guide](docs/THIRD-PARTY-SOURCE.md), and the applicable notices shipped
with the release.
...
For filesystem safety, uninstalling preserves local settings, the journal, logs, and other app
data. Fully close and uninstall the app, then follow the manual deletion instructions in the
...
General inquiries about these terms or the product: `support@pcssak.com`
